...
public class MetricsManager {
    ...
    private static final boolean metricsStatus = (new RConfig("config.yml", RenYuanLib.getInstance())).getBoolean("metrics-global");
    ...
    public MetricsManager(JavaPlugin plugin, int serviceId) {
        ...
        if (!new RConfig("config.yml", plugin).getBoolean("metrics")) return;
